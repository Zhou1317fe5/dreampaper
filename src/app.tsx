            ...
            {job.status === 'failed' && job.error && (
              <div className="error-diagnostic" aria-label={t.result.errorTitle}>
                ...
                <dl>
                  ...
                  {job.error.stage && <><dt>{t.result.errorStage}</dt><dd>{job.error.stage}</dd></>}
